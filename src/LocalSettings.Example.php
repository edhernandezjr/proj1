...
$wgSitename = "lenipedia";
$wgMetaNamespace = "Lenipedia";
...
$wgLogos = [ 
	...
	'logoessential' => "$wgResourceBasePath/skins/Essential/resources/logo-symbol-only.png",
	'banneressential' => "$wgResourceBasePath/skins/Essential/resources/images/banner.jpeg"
];
...
$wgFooterIcons = [
	...
	"social" => [
		"facebook" => 
			<<<'EOD'
				<a class="flex flex-row items-center gap-x-2" target="_blank" href="https://facebook.com/some-slug-here">
		...
		"twitter" => 
			<<<'EOD'
				<a class="flex flex-row items-center gap-x-2" target="_blank" href="https://twitter/some-slug-here">
		...
		"youtube" => 
			<<<'EOD'
				<a class="flex flex-row items-center gap-x-2" target="_blank" href="https://youtube/some-slug-here">
		...
		"instagram" => 
			<<<'EOD'
				<a class="flex flex-row items-center gap-x-2" target="_blank" href="https://instagram/some-slug-here">
