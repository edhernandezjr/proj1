...
//			file_picker_types: 'file image media',
			...
			menubar: 'edit insert view format table tools categories', //'',
			contextmenu_never_use_native: false,
			// fontawesome configuration
			// tinymce configuration
			toolbar_sticky: true,
			toolbar: 'categoriesButton | undo redo | cut copy paste insert selectall | fontselect fontsizeselect bold italic underline strikethrough subscript superscript forecolor backcolor | alignleft aligncenter alignright alignjustify | bullist numlist advlist outdent indent | wikilink wikiunlink table image media | formatselect removeformat| visualchars visualblocks| searchreplace | wikimagic wikisourcecode wikitext wikiupload | wikitoggle nonbreaking singlelinebreak reference comment template',
			...
			setup: function (editor) {
			  ...
			  editor.ui.registry.addSplitButton('categoriesButton', {
				text: 'Categories',
				onAction: function () {
